...
Keybinds default_values() {
    ...
    SET_DEFAULT(DIVIDE_NEAREST, 'D', 0b010); 
    SET_DEFAULT(DRAWING_FRAME, 'X', 0b011); 
    SET_DEFAULT(EXTRUDE_ADD, '[', 0b000); 
    SET_DEFAULT(EXTRUDE_CUT, '[', 0b010); 
    ...
    SET_DEFAULT(PREVIOUS_HOT_KEY_3D, ' ', 0b010); 
    ...
    SET_DEFAULT(REDO, 'U', 0b010); 
    SET_DEFAULT(REDO_ALTERNATE, 'Y', 0b011); 
    SET_DEFAULT(RESIZE, 'S', 0b010); 
    SET_DEFAULT(REVOLVE_ADD, ']', 0b000); 
    SET_DEFAULT(REVOLVE_CUT, ']', 0b010); 
    ...
    SET_DEFAULT(TWO_EDGE_CIRCLE, 'C', 0b010); 
    SET_DEFAULT(UNDO, 'U', 0b000); 
    SET_DEFAULT(UNDO_ALTERNATE, 'Z', 0b001); 
